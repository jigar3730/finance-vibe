...
This guide outlines how to interpret the macro-trend metrics generated by the `finance_vibe` processing pipeline and convert them into precise brokerage orders. It uses a **5-year weekly timeframe** to filter out market noise and capture major institutional capital flows.
@jigar3730 ➜ /workspaces/finance-vibe (main) $ python ./src/finance_vibe/dashboard_engine.py 
Latest Weekly Structure & Entry/Exit Triggers for NVDA:
Price            Close  Swing_High_4wk  Swing_Low_4wk  Vibe_Score  Entry_Signal  Exit_Signal
Date                                                                                        
2026-06-08  204.309998      232.009587     199.339996           6         False        False
@jigar3730 ➜ /workspaces/finance-vibe (main) $ 
