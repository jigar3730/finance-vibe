"""Walk-forward backtest of the offline quality-swing path.

Replays swing scanner setup detection and trade-planner stock levels on historical
OHLC bars, gated by macro Vibe Score. Not an ML input and not invoked by run_vibe.

Usage:
    python -m finance_vibe.lab.pipeline_backtest daily
